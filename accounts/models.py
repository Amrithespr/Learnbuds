...
from jobportal.views import CompanyFeedback
...
#     cv = models.ImageField(upload_to='../static/resumes')    
#     photo = models.ImageField(upload_to='../static/photos') 
#     job_title = models.CharField(max_length=50)   
#     company = models.CharField(max_length=50,  null=True, blank=True)   
#     levelOfEducation = models.CharField(max_length=50, null=True, blank=True)   
#     fieldOfStudy = models.CharField(max_length=50, null=True, blank=True)  
#     school = models.CharField(max_length=50, null=True, blank=True) 
#     skills = models.TextField()  
#     certifications = models.TextField()   
#     newJobTitle = models.CharField(max_length=50, null=True, blank=True)   
#     newJobType = models.CharField(max_length=50, null=True, blank=True)   
#     newWorkSchedule = models.CharField(max_length=50, null=True, blank=True)   
#     newSalary = models.CharField(max_length=50, null=True, blank=True)   
